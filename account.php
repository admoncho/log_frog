		...
		<!-- <div class="col-sm-12 col-md-6">
			<div class="main-box clearfix">
				...
				<div class="main-box-body clearfix">
					...
					<?php
					# If user has avatar
					// echo file_exists($img_content_directory . '/user/avatar/' . $user->data()->id . '.jpg') ? '<img src="/img/content/user/avatar/' . $user->data()->id . '.jpg' . '?r=' . date('Gis') . '" alt="" class="profile-img img-responsive center-block alt="" />' : '';	
