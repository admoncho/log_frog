...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    ...
    <body id="skin-tectile">
        <section id="login">
            ...
            <!-- Login -->
            <form class="box tile animated active" id="box-login" action="/dashboard" method="post">
                <h2 class="m-t-0 m-b-15">Login <span class="pull-right"><img src="<?= $_SESSION['HtmlDelimiter'] ?>img/imager/logo.jpg"></span></h2>
                <input type="text" class="login-control m-b-10" name="email" placeholder="Email Address">
                <input type="password" class="login-control" name="password" placeholder="Password">
