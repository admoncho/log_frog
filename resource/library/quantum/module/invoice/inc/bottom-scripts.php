...
session_start();
ob_start();
if ($_SESSION['$clean_php_self'] == '/dashboard/invoice/index.php' || $_SESSION['$clean_php_self'] == '/dashboard/invoice/index_TEST.php') { ?>
	...
	<script src="<?= $_SESSION["href_location"] ?>js/daterangepicker.js"></script> <?php
}?>
...
$(document).ready(function() {
	...
	document.getElementById("invoice-table_length").setAttribute("style", "margin-left: 15px;");
	document.getElementById("invoice-table_filter").setAttribute("style", "margin-right: 15px;");
