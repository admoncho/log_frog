...
# Broker
$broker = DB::getInstance()->query("SELECT * FROM broker_address WHERE broker_id = " . $_GET['schedule_broker_id'] . " && address_type = 1");
...
if ($client_id_invoice_color[$client_assoc_factoring_company_client_id]) {
	
	$invoice_color = $client_id_invoice_color[$client_assoc_factoring_company_client_id];
} else {

	$invoice_color = 'b00b00';
}
