...
class User {
	...
	public function find($user = null) {
		...
		if($user) {
			...
			$data = $this->_db->get('_QU_i', array($field, '=', $user));
	...
	public function create($fields = array()) {
		if(!$this->_db->insert('_QU_i', $fields)) {
	...
	public function update($fields = array(), $id = null) {
		...
		if(!$this->_db->update('_QU_i', $id, $fields)) {
	...
	public function hasPermission($key) {
		...
		/*$group_id = $this->_db->query("SELECT * FROM _QU_i_group_assoc WHERE user_id = ?", array($this->data()->user_id));
		...
		// $group = $this->_db->query("SELECT * FROM _QU_i_group WHERE group_id = ?", array($group_id_value));
		if($group->count()) {
