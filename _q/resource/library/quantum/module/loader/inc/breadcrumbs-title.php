    ...
    if ($bol_exists[1] && $rate_confirmation_exists[1]) {
      ...
      if ($schedule_count && $schedule_load_count) { ?>
        ...
        data-content='
          <div>
            <?php
            if (($factoring_company_requires_soar[1] && file_exists(str_replace('_q', '', $_SESSION['ProjectPath']) . 'files/schedule/bg/' . $load_client_id[1] . '.jpg')) || !$factoring_company_requires_soar[1]) { ?>
