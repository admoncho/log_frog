...
for ($i=1; $i <= $soar_num_pages ; $i++) { 
	...
	<div class="hidden" style="position: absolute; top: 0; left: 0; width: 785px; height: 1001px; background: url(http://<?= $domain ?>/files/schedule/bg/<?= Input::get('client_assoc_id') ?>.jpg);"></div> <?php
