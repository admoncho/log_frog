...
<aside id="sidebar">
  ...
  <div class="side-widgets overflow">
    ...
    <div class="text-center s-widget m-b-25 dropdown" id="profile-menu">
      <a href="" data-toggle="dropdown">
        <img class="fa fa-user animated" src="<?= $_SESSION["href_location"] ?>img/imager/logo.jpg" alt="" style="margin: 15px 0;">
      </a>
      ...
      <h4 class="m-0"><?= $user->data()->name . ' ' . $user->data()->last_name ?></h4>
      <?= $user->data()->email ?>
    </div>
  ...
  <ul class="list-unstyled side-menu">
    <li<?= $_SERVER['REQUEST_URI'] == '/dashboard' ? ' class="active"' : '' ?>>
      <a class="sa-side-home" href="<?= $_SESSION['href_location'] ?>dashboard">
        <span class="menu-item">Dashboard</span>
      </a>
    </li>
    <li<?= $_SERVER['REQUEST_URI'] == '/invoicing' ? ' class="active"' : '' ?>>
      <a class="sa-side-form" href="<?= $_SESSION['href_location'] ?>invoicing">
