...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
	...
	<script src="<?= $_SESSION["href_location"] ?>js/demo-rtl.js"></script>
	<!-- 
	If you need RTL support just include here RTL CSS file <link rel="stylesheet" type="text/css" href="/css/quantum/libs/bootstrap-rtl.min.css" />
	...
	<link rel="stylesheet" type="text/css" href="<?= $_SESSION['href_location'] ?>css/quantum/libs/dataTables.fixedHeader.css">
	<link rel="stylesheet" type="text/css" href="<?= $_SESSION['href_location'] ?>css/quantum/libs/dataTables.tableTools.css">
...
<body>
						...
						<div id="col-left-inner" class="col-left-nano-content">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="sidebar-nav">	
								<ul class="nav nav-pills nav-stacked">
									...
									<li>
										<a href="<?= $_SESSION['href_location'] ?>angularjs">
	...
	<!-- global scripts -->
	<script src="<?= $_SESSION["href_location"] ?>js/demo-skin-changer.js"></script> <!-- only for demo -->
	
	<script src="<?= $_SESSION["href_location"] ?>js/jquery.js"></script>
	<script src="<?= $_SESSION["href_location"] ?>js/bootstrap.js"></script>
	<script src="<?= $_SESSION["href_location"] ?>js/jquery.nanoscroller.min.js"></script>
	
	<script src="<?= $_SESSION["href_location"] ?>js/demo.js"></script> <!-- only for demo -->
	...
	<script src="<?= $_SESSION["href_location"] ?>js/pace.min.js"></script>
