					...
					<form action="" method="post">
						...
						<div class="row">
							...
							<div class="form-group col-sm-12 col-md-2">
								...
								<input name="weight" type="number" class="form-control" min="1" value="<?= str_replace(',', '', $draft_weight[1]) ?>">
							</div>
			...
			<div class="main-box-body clearfix">
				<div class="row">
		          ...
		          <div class="form-group hidden">
		            ...
		            <select id="lead-status" name="status" class="form-control" readonly>
									...
									<option value="4"<?= $pick_drop_ready ? '' : ' disabled' ?> selected>Accepted</option>
								</select>
		          </div>
		          <!-- THIS IS HIDDEN -->
